...
java -jar sl-build-scanner-1.9.487.jar -config -tokenfile sl_token.txt -appname "VisualCaptchaSelenium_PTC" -branchname origin/master -buildname "18" -pi "com.kuhniverse.*"
mvn clean install  -Psealights_build

echo ----------------------Building, deploying webapp----------------------
npm i slnodejs
./node_modules/.bin/slnodejs config --tokenfile sl_token.txt --appname "VisualCaptchaSeleniumWeb_PTC" --branch "origin/master" --build "12"
...
./node_modules/.bin/slnodejs config --tokenfile sl_token.txt --appname "VisualCaptcha" --branch "origin/master" --build "20"
